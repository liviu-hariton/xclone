 ...
 */
final class Version20231124102108 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_profile CHANGE date_of_birth date_of_birth DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_profile CHANGE date_of_birth date_of_birth VARCHAR(255) DEFAULT NULL');
    }
}
